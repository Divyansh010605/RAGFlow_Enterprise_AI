...
def initialize() -> None:
    with connection() as conn:
        ...
        CREATE TABLE IF NOT EXISTS agent_runs (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, query TEXT NOT NULL, status TEXT NOT NULL, latency_ms INTEGER, created_at TEXT DEFAULT CURRENT_TIMESTAMP);
        ...
        CREATE TABLE IF NOT EXISTS sales (region TEXT PRIMARY KEY, quarter TEXT NOT NULL, revenue REAL NOT NULL, manager TEXT NOT NULL);
        """)
        # BUG-31: Add agent_id column to agent_runs if it doesn't exist yet (safe migration)
